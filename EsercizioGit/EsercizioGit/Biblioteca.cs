...
namespace EsercizioGit
{
    internal class Biblioteca
    {
        ...
        List<string> libri;
        public Biblioteca(string nome, string indirizzo, string orarioApertura, string orarioChiusura, List<string> libri)
        {
            this.nome = nome;
        ...
        public List<String> Libri { get; set; }

        // TODO: Integrare le operazioni della classe Libro nella classe Biblioteca

        public static void AggiugniLibro(string autore, string nome, string editore, int anno, int pagine)
        {
        ...
        public static Libro CercaAutore(string autore)
        {
